...
class MyPhotoFolderModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      list: [],
  ...
  getDataItem() {
    ...
    return (_this.state.list &&
      _this.state.list.map((item, index) => {
        return (
          <div className="list-item fl ml10 mt15" key={index}>
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <div className="clearfix photo-gallery-btn">
          ...
          <div className="clearfix mt30">
            <div className="mt30 fr" style={{textAlign: "right", paddingRight: "50px"}}>
              <Pagination defaultCurrent={1} total={this.state.total} pageSize={10}
...
export default MyPhotoFolderModal;
