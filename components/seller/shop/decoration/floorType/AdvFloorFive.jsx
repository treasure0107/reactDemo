...
class AdvFloorFive extends Component {
	constructor() {
		super()
	...
	render() {
		...
		return (
			<div className="advFloorFive floorWrapper">
				<Header
					floorNum={floorNum}
					floorSort={floorSort}
					isFloor={true}
					desc={floorConfig.advFloorFive.headerTitle}
					floorType={floorConfig.advFloorFive.type}
					confirmEdit={this.confirmEdit}
					sortChange={this.sortChange}
				>
					<div className="slideshow6">
						{
							floorData.map((floor, index) => (
								<div className="floor6" key={index}>
	...
	confirmEdit() {
		...
		const floorType = floorConfig.advFloorFive.type
		asyncSetFloorList({
			floorType,
			dataList,
...
export default connect(mapState, mapDispatch)(AdvFloorFive)